                  ...
                  {!imageError && personalData.profilePic ? (
                    <>
                      ...
                      <img
                        ...
                        className={`w-full h-full object-cover object-center transition-all scale-100 duration-500 group-hover:scale-110 ${imageLoaded ? 'opacity-100' : 'opacity-0'
                          }`}
          ...
          <div className="space-y-6">
            ...
            <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2">
              <div className="flex flex-col items-center animate-bounce">
                <ChevronDown size={32} className="text-blue-400 drop-shadow-lg" />
                <span className="text-sm text-gray-400 mt-1">Scroll</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              {sectionsData.hero.ctaButtons.map((button, index) => (
                <button
                  ...
                  className={`group px-8 py-4 flex items-center gap-2 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 ${button.type === 'primary'
            ...
            <div className="flex justify-center space-x-6 pt-4">
              {[
                ...
                <a
                  ...
                  className="group relative p-3 bg-slate-800/50 hover:bg-slate-700/70 rounded-full text-gray-400 hover:text-white transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 backdrop-blur-sm"
                  aria-label={label}
                >
                  <Icon size={24} className="group-hover:rotate-6 transition-transform" />
                  <span className="absolute -bottom-8 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 text-xs bg-slate-900 text-gray-300 px-2 py-1 rounded-md transition-opacity duration-300">
                    {label}
                  </span>
                </a>
              ))}
